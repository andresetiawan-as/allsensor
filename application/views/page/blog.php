...
<div class="super_container">
			...
			<div class="header_extra ml-auto d-flex flex-row align-items-center justify-content-start">
				...
				<div class="cart d-flex flex-row align-items-center justify-content-start">
					<div class="cart_icon"><a href="cart.html">
						<img src="<?php echo base_url();?>assets/images/images/bag.png" alt="">
	...
	<div class="home">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="<?php echo base_url();?>assets/images/blog.jpg" data-speed="0.8"></div>
			...
			<div class="home_content">
				...
				<div class="breadcrumbs">
					<ul class="d-flex flex-row align-items-center justify-content-start">
						...
						<li>Blog</li>
						<li><a href="categories.html">categori</a></li>
					</ul>
				</div>
			</div>
		</div>
				...
				<div class="row">
					<div class="col">
						...
						<div class="blog_bosts">
							...
							<!-- Blog Post -->
							<div class="blog_post">
								<div class="blog_post_image"><img src="<?php echo base_url();?>assets/images/blog_1.jpg" alt="https://unsplash.com/@saskiafairfull"></div>
						...
						<div class="blog_bosts">
							...
							<!-- Blog Post -->
							<div class="blog_post">
								<div class="blog_post_image"><img src="<?php echo base_url();?>assets/images/blog_2.jpg" alt="https://unsplash.com/@veronezcaroline"></div>
								<div class="blog_post_content">
									<div class="blog_post_date"><a href="#">June 18, 2018</a></div>
						...
						<div class="blog_bosts">
							...
							<!-- Blog Post -->
							<div class="blog_post">
								<div class="blog_post_image"><img src="<?php echo base_url();?>assets/images/blog_3.jpg" alt=""></div>
								<div class="blog_post_content">
									<div class="blog_post_date"><a href="#">June 18, 2018</a></div>
