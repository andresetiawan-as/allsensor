...
<body>
	...
	<div class="super_container">
			...
			<div class="header_content d-flex flex-row align-items-center justify-content-start">
				...
				<nav class="header_nav">
					<ul class="d-flex flex-row align-items-center justify-content-start">
						<li><a href="<?php echo base_url();?>index.php/AllsensorCtr/index">home</a></li>
						<li><a href="<?php echo base_url();?>index.php/AllsensorCtr/cart">cart</a></li>
						<li><a href="<?php echo base_url();?>index.php/AllsensorCtr/categories">categories</a></li>
						<li><a href="<?php echo base_url();?>index.php/AllsensorCtr/checkout">checkout</a></li>
						<li><a href="<?php echo base_url();?>index.php/AllsensorCtr/product">product</a></li>
						<li><a href="<?php echo base_url();?>index.php/AllsensorCtr/blog">blog</a></li>
		...
		<div class="menu d-flex flex-column align-items-start justify-content-start menu_mm trans_400">
			...
			<nav class="menu_nav">
				<ul class="menu_mm">
					<li class="menu_mm"><a href="<?php echo base_url();?>index.php/AllsensorCtr/index">home</a></li>
					<li><a href="<?php echo base_url();?>index.php/AllsensorCtr/cart">cart</a></li>
					<li><a href="<?php echo base_url();?>index.php/AllsensorCtr/categories">categories</a></li>
					<li><a href="<?php echo base_url();?>index.php/AllsensorCtr/checkout">checkout</a></li>
					<li><a href="<?php echo base_url();?>index.php/AllsensorCtr/product">product</a></li>
					<li class="menu_mm"><a href="<?php echo base_url();?>index.php/AllsensorCtr/blog">blog</a></li>
		...
		<div class="sidebar">
			...
			<nav class="sidebar_nav">
				<ul>
					<li><a href="<?php echo base_url();?>index.php/AllsensorCtr/index">home<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
					<li><a href="<?php echo base_url();?>index.php/AllsensorCtr/cart">cart</a></li>
					<li><a href="<?php echo base_url();?>index.php/AllsensorCtr/categories">categories</a></li>
					<li><a href="<?php echo base_url();?>index.php/AllsensorCtr/checkout">checkout</a></li>
					<li><a href="<?php echo base_url();?>index.php/AllsensorCtr/product">product</a></li>
					<li><a href="<?php echo base_url();?>index.php/AllsensorCtr/blog">blog<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
		...
		<div class="home">
			...
			<div class="home_slider_container">
				...
				<div class="home_slider_nav home_slider_prev trans_200">
					<div class=" d-flex flex-column align-items-center justify-content-center"><img src="<?php echo base_url(); ?>assets/images/prev.png" alt=""></div>
				</div>
				<div class="home_slider_nav home_slider_next trans_200">
					<div class=" d-flex flex-column align-items-center justify-content-center"><img src="<?php echo base_url(); ?>assets/images/next.png" alt=""></div>
				</div>
