...
<div class="sidebar">
    ...
    <!-- <div class="sidebar_logo">
        <a href="#">
            <div style="font-size:2em;">All<span>sensor</span></div>
        </a>
    </div> -->
    <div class="header_logo" style="padding-top: 25%;">
        <a href="<?php echo base_url();?>index.php/AllsensorCtr/index">
            <div style="font-size:2em;">AL<span style="color:orange;">LSensor</span></div>
        </a>
    </div>
    ...
    <nav class="sidebar_nav">
        <ul>
            ...
            <li><a href="<?php echo base_url();?>index.php/AllsensorCtr/cart">cart<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
            <li><a href="<?php echo base_url();?>index.php/AllsensorCtr/categories">categories<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
            <li><a href="<?php echo base_url();?>index.php/AllsensorCtr/checkout">checkout<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
            <li><a href="<?php echo base_url();?>index.php/AllsensorCtr/product">product<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
