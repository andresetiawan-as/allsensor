                            ...
                            <div class="footer_contact_list">
                                <ul>
                                    <li class="d-flex flex-row align-items-start justify-content-start"><span><i class="fa fa-user" aria-hidden="true"></i> Tel : </span>
                                        <div>+62 21 2941 1858</div>
                                    </li>
                                    <li class="d-flex flex-row align-items-start justify-content-start"><span><i class="fa fa-whatsapp" aria-hidden="true"></i> Whatsapp : </span>
                                        <div>+62 812 98007500</div>
                                    </li>
                                    <li class="d-flex flex-row align-items-start justify-content-start"><span><i class="fa fa-envelope" aria-hidden="true"></i> Email : </span>
                                    ...
                                    <li class="d-flex flex-row align-items-start justify-content-start"><span><i class="fa fa-map-marker" aria-hidden="true"></i> Add : </span>
                                        <div>Jalan Raya Prancis, Ruko Kosambi Megah No. 29 Jatimulya, Kosambi, Kab. Tangerang, Banten, 15211 - Indonesia</div>
                                    </li>
                                </ul>
                            </div>
                        </div>
